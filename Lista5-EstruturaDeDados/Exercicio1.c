/*1- Escreva um programa que gere uma lista com 1000 valores aleatórios (com
números entre 0 e 10000), ordene os números, e faça uma comparação entre
a busca sequencial e a busca binária, tal que ao final seja exibido a
quantidade de testes realizado em cada método. O valor buscado é
