/*3- Crie uma lista de livros contendo um código, nome do livro, ano de publicação
e autor. Desenvolva um método para buscar um livro pelo código e
desenvolva um método que permite buscar pela letra inicial do nome do autor
e do ano de publicação.*/
