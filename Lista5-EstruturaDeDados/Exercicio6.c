/*6- Escreva um algoritmo, usando uma Pilha, que inverte as letras de cada
palavra de um texto preservando a ordem das palavras. Por exemplo, dado
o texto: ESTE EXERCICIO E MUITO FACIL. A saída deve ser: ETSE
